// components/savings/SavingTypeSelector.tsx
import { useAppTheme } from "@/app/providers/ThemeProvider";
import { SAVING_TYPES } from "@/types/saving";
...
export default function SavingTypeSelector({ selectedType, onSelectType }: Props) {
